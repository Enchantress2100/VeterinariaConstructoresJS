...
if (tipo=='perro'){
    ...
    let gato= new Mascota(propietario, telefono, direccion, tipo,nombreMascota,enfermedad)
    ...
    let conejo=new Mascota(propietario,telefono,direccion, tipo,nombreMascota, enfermedad)
